...
return e.getParam("spellchecker_wordchar_pattern",t)},s=function(e){return e&&1===e.nodeType&&"false"===e.contentEditable},l=function(e,t){var n
return t.get()||(n=function(e,t){var n,r=[],o=t.dom,a=t.schema.getBlockElements(),i=t.schema.getWhiteSpaceElements(),c=t.schema.getShortEndedElements(),l=function(e){var t
if(3===e.nodeType)return e.data
if(i[e.nodeName]&&!a[e.nodeName])return""
if(s(e))return"\n"
if(t="",(a[e.nodeName]||c[e.nodeName])&&(t+="\n"),e=e.firstChild)for(;t+=l(e),e=e.nextSibling;);return t},u=function(e){for(var t=e.parentNode;0<e.childNodes.length;)t.insertBefore(e.childNodes[0],e)
t.removeChild(e)},d=function(t){var n=e.getElementsByTagName("*"),r=[]
t="number"==typeof t?""+t:null
for(var o=0;o<n.length;o++){var a=n[o],i=a.getAttribute("data-mce-index")
null!==i&&i.length&&-1!==a.className.indexOf("mce-spellchecker-word")&&(i!==t&&null!==t||r.push(a))}return r},f=function(e){for(var t=r.length;t--;)if(r[t]===e)return t
return-1}
function h(e){for(var t=0,n=r.length;t<n&&!1!==e(r[t],t);t++);return this}function g(e){for(var t=d(e?f(e):null),n=t.length;n--;)u(t[n])
return this}var p=function(e){var n=d(f(e)),r=t.dom.createRng()
return r.setStartBefore(n[0]),r.setEndAfter(n[n.length-1]),r},m=l(e)
return{text:m,matches:r,each:h,filter:function(e){var t=[]
return h((function(n,r){e(n,r)&&t.push(n)})),r=t,this},reset:function(){return r.splice(0,r.length),g(),this},matchFromElement:function(e){return r[e.getAttribute("data-mce-index")]},elementFromMatch:function(e){return d(f(e))[0]},find:function(e,t){if(m&&e.global)for(;n=e.exec(m);)r.push(function(e,t){if(!e[0])throw new Error("findAndReplaceDOMText cannot handle zero-length matches")
return{start:e.index,end:e.index+e[0].length,text:e[0],data:t}}(n,t))
return this},add:function(e,t,n){return r.push({start:e,end:e+t,text:m.substr(e,t),data:n}),this},wrap:function(t){var n,l
...
g=g.parentNode}}}(e,r,(n=t,l=function(e,t){var a=r[t]
a.stencil||(a.stencil=n(a))
var i=a.stencil.cloneNode(!1)
return i.setAttribute("data-mce-index",t),e&&i.appendChild(o.doc.createTextNode(e)),i},function(e){var t,n,r=e.startNode,a=e.endNode,i=e.matchIndex,c=o.doc
if(r===a){var s=r,u=s.parentNode
0<e.startNodeIndex&&(t=c.createTextNode(s.data.substring(0,e.startNodeIndex)),u.insertBefore(t,s))
var d=l(e.match,i)
return u.insertBefore(d,s),e.endNodeIndex<s.length&&(n=c.createTextNode(s.data.substring(e.endNodeIndex)),u.insertBefore(n,s)),s.parentNode.removeChild(s),d}t=c.createTextNode(r.data.substring(0,e.startNodeIndex)),n=c.createTextNode(a.data.substring(e.endNodeIndex))
for(var f=l(r.data.substring(e.startNodeIndex),i),h=0,g=e.innerNodes.length;h<g;++h){var p=e.innerNodes[h],m=l(p.data,i)
p.parentNode.replaceChild(m,p)}var v=l(a.data.substring(0,e.endNodeIndex),i)
return(u=r.parentNode).insertBefore(t,r),u.insertBefore(f,r),u.removeChild(r),(u=a.parentNode).insertBefore(v,a),u.insertBefore(n,a),u.removeChild(a),v})),this},unwrap:g,replace:function(e,n){var r=p(e)
return r.deleteContents(),0<n.length&&r.insertNode(t.dom.doc.createTextNode(n)),r},rangeFromMatch:p,indexOf:f}}(e.getBody(),e),t.set(n)),t.get()},u=function(e,t,n,c,s,l,u){var d,f,h;(e.getParam("spellchecker_callback")||(d=e,f=t,h=n,function(e,t,n,c){var s={method:e,lang:h.get()},l=""
...
return N(t,n,r,a,o,i),y(t,n,i,r,a,o),p=n,v=r,x=a,k=i,S=o,(g=t).addCommand("mceSpellCheck",(function(){d(g,p,v,x,k,S)})),s=t,l=r,u=i,h=o,{getTextMatcher:(f=a).get,getWordCharPattern:function(){return c(s)},markErrors:function(e){m(s,l,f,u,e)},getLanguage:h.get}}var s,l,u,f,h,g,p,v,x,k,S,b,w}))}()
