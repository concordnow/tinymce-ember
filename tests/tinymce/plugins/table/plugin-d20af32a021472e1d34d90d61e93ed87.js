...
E(pe(n),t),E(ve(n),t)},Eu=function(n){return Pn.fromDom(n.selection.getStart())},Pu=function(n){return Ir(n.get(),d([]),g,q)},Nu=function(n){var t=function(n,t){return qt(n,t).exists((function(n){return parseInt(n,10)>1}))},e=Pu(n)
