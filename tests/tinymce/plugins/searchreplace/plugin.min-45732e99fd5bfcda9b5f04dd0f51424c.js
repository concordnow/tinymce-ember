...
V(i=e,a=n)||_(i,a)||U(i,a)||(u=a,"true"===(c=i).getContentEditable(u)&&"false"===c.getContentEditableParent(u.parentNode))||(l=e.getParent(r,e.isBlock),f=new q(n,l),d=o?f.next.bind(f):f.prev.bind(f),z(e,d,n,{boundary:s,cef:s,text:function(e){o?t.fOffset+=e.length:t.sOffset+=e.length,t.elements.push(P(e))}}))},K=function(e,t,n,r,o,i){void 0===i&&(i=!0)
...
return z(e,a.next.bind(a),n,{boundary:l,cef:function(e){return l(),o&&c.push.apply(c,o.cef(e)),!1},text:function(e){u.elements.push(P(e)),o&&o.text(e,u)}},r,i),r&&G(e,u,r,t,!0),l(),c},H=function(e,t){var n=$(t.startContainer,t.startOffset),r=n.element.dom,o=$(t.endContainer,t.endOffset),i=o.element.dom
...
e.undoManager.add()
var o=v.trim(e.selection.getContent({format:"text"})),a=function(e){(1<t.get().count?e.enable:e.disable)("next"),(1<t.get().count?e.enable:e.disable)("prev")},u=function(e,t){var n=t?e.disable:e.enable
