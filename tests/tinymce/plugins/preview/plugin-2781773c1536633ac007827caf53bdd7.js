...
n.each(e.contentCSS,(function(t){i+='<link type="text/css" rel="stylesheet" href="'+o(e.documentBaseURI.toAbsolute(t))+'"'+a+">"})),r&&(i+='<style type="text/css">'+r+"</style>")
...
e.add("preview",(function(e){(function(e){e.addCommand("mcePreview",(function(){i(e)}))})(e),function(e){var t=function(){return e.execCommand("mcePreview")}
e.ui.registry.addButton("preview",{icon:"preview",tooltip:"Preview",onAction:t}),e.ui.registry.addMenuItem("preview",{icon:"preview",text:"Preview",onAction:t})}(e)}))})()
