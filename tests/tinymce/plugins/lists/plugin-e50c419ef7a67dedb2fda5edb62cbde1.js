(function(){"use strict"
var e=tinymce.util.Tools.resolve("tinymce.PluginManager"),n=function(){},t=function(e){return function(){return e}},r=function(e){return function(n){return!e(n)}},o=t(!1),i=t(!0),u=function(){return a},a=function(){var e=function(e){return e.isNone()},r=function(e){return e()},a=function(e){return e}
return{fold:function(e,n){return e()},is:o,isSome:o,isNone:i,getOr:a,getOrThunk:r,getOrDie:function(e){throw new Error(e||"error: getOrDie called on none.")},getOrNull:t(null),getOrUndefined:t(void 0),or:a,orThunk:r,map:u,each:n,bind:u,exists:o,forall:i,filter:u,equals:e,equals_:e,toArray:function(){return[]},toString:t("none()")}}(),s=function(e){var n=t(e),r=function(){return c},u=function(n){return n(e)},c={fold:function(n,t){return t(e)},is:function(n){return e===n},isSome:i,isNone:o,getOr:n,getOrThunk:n,getOrDie:n,getOrNull:n,getOrUndefined:n,or:r,orThunk:r,map:function(n){return s(n(e))},each:function(n){n(e)},bind:u,exists:u,forall:u,filter:function(n){return n(e)?c:a},toArray:function(){return[e]},toString:function(){return"some("+e+")"},equals:function(n){return n.is(e)},equals_:function(n,t){return n.fold(o,(function(n){return t(e,n)}))}}
return c},c={some:s,none:u,from:function(e){return null==e?a:s(e)}},f=function(e){return function(n){return r=typeof(t=n),(null===t?"null":"object"===r&&(Array.prototype.isPrototypeOf(t)||t.constructor&&"Array"===t.constructor.name)?"array":"object"===r&&(String.prototype.isPrototypeOf(t)||t.constructor&&"String"===t.constructor.name)?"string":r)===e
var t,r}},d=function(e){return function(n){return typeof n===e}},l=f("string"),m=f("array"),p=d("boolean"),v=d("function"),g=d("number"),h=Array.prototype.slice,y=Array.prototype.push,S=function(e,n){for(var t=e.length,r=new Array(t),o=0;o<t;o++){var i=e[o]
r[o]=n(i,o)}return r},b=function(e,n){for(var t=0,r=e.length;t<r;t++){n(e[t],t)}},C=function(e,n){for(var t=[],r=0,o=e.length;r<o;r++){var i=e[r]
n(i,r)&&t.push(i)}return t},N=function(e,n,t){return b(e,(function(e){t=n(t,e)})),t},O=function(e,n,t){for(var r=0,o=e.length;r<o;r++){var i=e[r]
if(n(i,r))return c.some(i)
if(t(i,r))break}return c.none()},L=function(e,n){return O(e,n,o)},T=function(e,n){return function(e){for(var n=[],t=0,r=e.length;t<r;++t){if(!m(e[t]))throw new Error("Arr.flatten item "+t+" was not an array, input: "+e)
y.apply(n,e[t])}return n}(S(e,n))},D=function(e){var n=h.call(e,0)
return n.reverse(),n},w=function(e,n){return n>=0&&n<e.length?c.some(e[n]):c.none()},k=function(e){return w(e,0)},x=function(e){return w(e,e.length-1)},A=function(){return(A=Object.assign||function(e){for(var n,t=1,r=arguments.length;t<r;t++)for(var o in n=arguments[t])Object.prototype.hasOwnProperty.call(n,o)&&(e[o]=n[o])
return e}).apply(this,arguments)}
var E,P,B,I,R=function(){return M(0,0)},M=function(e,n){return{major:e,minor:n}},U={nu:M,detect:function(e,n){var t=String(n).toLowerCase()
...
return L(e,(function(e){return e.search(t)}))},F=function(e,n){return _(e,n).map((function(e){var t=U.detect(e.versionRegexes,n)
return{current:e.name,version:t}}))},H=function(e,n){return _(e,n).map((function(e){var t=U.detect(e.versionRegexes,n)
return{current:e.name,version:t}}))},$=function(e,n){return-1!==e.indexOf(n)},j=/.*?version\/\ ?([0-9]+)\.([0-9]+).*/,q=function(e){return function(n){return $(n,e)}},K=[{name:"Edge",versionRegexes:[/.*?edge\/ ?([0-9]+)\.([0-9]+)$/],search:function(e){return $(e,"edge/")&&$(e,"chrome")&&$(e,"safari")&&$(e,"applewebkit")}},{name:"Chrome",versionRegexes:[/.*?chrome\/([0-9]+)\.([0-9]+).*/,j],search:function(e){return $(e,"chrome")&&!$(e,"chromeframe")}},{name:"IE",versionRegexes:[/.*?msie\ ?([0-9]+)\.([0-9]+).*/,/.*?rv:([0-9]+)\.([0-9]+).*/],search:function(e){return $(e,"msie")||$(e,"trident")}},{name:"Opera",versionRegexes:[j,/.*?opera\/([0-9]+)\.([0-9]+).*/],search:q("opera")},{name:"Firefox",versionRegexes:[/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/],search:q("firefox")},{name:"Safari",versionRegexes:[j,/.*?cpu os ([0-9]+)_([0-9]+).*/],search:function(e){return($(e,"safari")||$(e,"mobile/"))&&$(e,"applewebkit")}}],V=[{name:"Windows",search:q("win"),versionRegexes:[/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/]},{name:"iOS",search:function(e){return $(e,"iphone")||$(e,"ipad")},versionRegexes:[/.*?version\/\ ?([0-9]+)\.([0-9]+).*/,/.*cpu os ([0-9]+)_([0-9]+).*/,/.*cpu iphone os ([0-9]+)_([0-9]+).*/]},{name:"Android",search:q("android"),versionRegexes:[/.*?android\ ?([0-9]+)\.([0-9]+).*/]},{name:"OSX",search:q("mac os x"),versionRegexes:[/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/]},{name:"Linux",search:q("linux"),versionRegexes:[]},{name:"Solaris",search:q("sunos"),versionRegexes:[]},{name:"FreeBSD",search:q("freebsd"),versionRegexes:[]},{name:"ChromeOS",search:q("cros"),versionRegexes:[/.*?chrome\/([0-9]+)\.([0-9]+).*/]}],W={browsers:t(K),oses:t(V)},Q="Edge",X="Chrome",z="Opera",Y="Firefox",G="Safari",J=function(e){var n=e.current,t=e.version,r=function(e){return function(){return n===e}}
return{current:n,version:t,isEdge:r(Q),isChrome:r(X),isIE:r("IE"),isOpera:r(z),isFirefox:r(Y),isSafari:r(G)}},Z={unknown:function(){return J({current:void 0,version:U.unknown()})},nu:J,edge:t(Q),chrome:t(X),ie:t("IE"),opera:t(z),firefox:t(Y),safari:t(G)},ee="Windows",ne="Android",te="Linux",re="Solaris",oe="FreeBSD",ie="ChromeOS",ue=function(e){var n=e.current,t=e.version,r=function(e){return function(){return n===e}}
return{current:n,version:t,isWindows:r(ee),isiOS:r("iOS"),isAndroid:r(ne),isOSX:r("OSX"),isLinux:r(te),isSolaris:r(re),isFreeBSD:r(oe),isChromeOS:r(ie)}},ae={unknown:function(){return ue({current:void 0,version:U.unknown()})},nu:ue,windows:t(ee),ios:t("iOS"),android:t(ne),linux:t(te),osx:t("OSX"),solaris:t(re),freebsd:t(oe),chromeos:t(ie)},se=function(e,n){var r=W.browsers(),o=W.oses(),i=F(r,e).fold(Z.unknown,Z.nu),u=H(o,e).fold(ae.unknown,ae.nu),a=function(e,n,r,o){var i=e.isiOS()&&!0===/ipad/i.test(r),u=e.isiOS()&&!i,a=e.isiOS()||e.isAndroid(),s=a||o("(pointer:coarse)"),c=i||!u&&a&&o("(min-device-width:768px)"),f=u||a&&!c,d=n.isSafari()&&e.isiOS()&&!1===/safari/i.test(r),l=!f&&!c&&!d
return{isiPad:t(i),isiPhone:t(u),isTablet:t(c),isPhone:t(f),isTouch:t(s),isAndroid:e.isAndroid,isiOS:e.isiOS,isWebView:t(d),isDesktop:t(l)}}(u,i,e,n)
return{browser:i,os:u,deviceType:a}},ce=function(e){return window.matchMedia(e).matches},fe=(E=function(){return se(navigator.userAgent,ce)},B=!1,function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n]
return B||(B=!0,P=E.apply(null,e)),P}),de=function(e){if(null==e)throw new Error("Node cannot be null or undefined")
...
return de(t)},fromDom:de,fromPoint:function(e,n,t){return c.from(e.dom.elementFromPoint(n,t)).map(de)}},me=function(e,n){return e.dom===n.dom},pe=function(e,n){return t=e.dom,r=n.dom,function(e,n,t){return 0!=(e.compareDocumentPosition(n)&t)}(t,r,Node.DOCUMENT_POSITION_CONTAINED_BY)
...
n(e[i],i)}},Ne=function(e,t){var r={}
return function(e,n,t,r){Ce(e,(function(e,o){(n(e,o)?t:r)(e,o)}))}(e,t,function(e){return function(n,t){e[t]=n}}(r),n),r},Oe=("undefined"!=typeof window?window:Function("return this;")(),function(e){return e.dom.nodeName.toLowerCase()}),Le=(I=1,function(e){return function(e){return e.dom.nodeType}(e)===I}),Te=function(e,n){var t=e.dom
Ce(n,(function(e,n){(function(e,n,t){if(!(l(t)||p(t)||g(t)))throw console.error("Invalid call to Attribute.set. Key ",n,":: Value ",t,":: Element ",e),new Error("Attribute value was not simple")
e.setAttribute(n,t+"")})(t,n,e)}))},De=function(e){return N(e.dom.attributes,(function(e,n){return e[n.name]=n.value,e}),{})},we=function(e){return c.from(e.dom.parentNode).map(le.fromDom)},ke=function(e){return S(e.dom.childNodes,le.fromDom)},xe=function(e,n){var t=e.dom.childNodes
return c.from(t[n]).map(le.fromDom)},Ae=function(e){return xe(e,0)},Ee=function(e){return xe(e,e.dom.childNodes.length-1)},Pe=function(e,n){we(e).each((function(t){t.dom.insertBefore(n.dom,e.dom)}))},Be=function(e,n){e.dom.appendChild(n.dom)},Ie=function(e,n){b(n,(function(n){Be(e,n)}))},Re=function(e){var n=e.dom
...
return x(t)},mn=function(e){var n=function(e){var n=ln(e,e.selection.getStart()),t=C(e.selection.getSelectedBlocks(),Ke)
return n.toArray().concat(t)}(e)
return pn(e,n)},pn=function(e,n){var t=S(n,(function(n){return ln(e,n).getOr(n)}))
return an.unique(t)},vn=function(e,n,t){return e.isSome()&&n.isSome()?c.some(t(e.getOrDie(),n.getOrDie())):c.none()},gn=function(e,n,t){return e.fire("ListMutation",{action:n,element:t})},hn=function(e,n,t){if(!l(t))throw console.error("Invalid call to CSS.set. Property ",n,":: Value ",t,":: Element ",e),new Error("CSS value must be a string: "+t);(function(e){return void 0!==e.style&&v(e.style.getPropertyValue)})(e)&&e.style.setProperty(n,t)},yn=function(e,n){Be(e.item,n.list)},Sn=function(e,n){var t={list:le.fromTag(n,e),item:le.fromTag("li",e)}
return Be(t.list,t.item),t},bn=function(e,n,t){var r=n.slice(0,t.depth)
return x(r).each((function(n){(function(e,n){Be(e.list,n),e.item=n})(n,function(e,n,t){var r=le.fromTag("li",e)
return Te(r,n),Ie(r,t),r}(e,t.itemAttributes,t.content)),function(e,n){Oe(e.list)!==n.listType&&(e.list=Ue(e.list,n.listType)),Te(e.list,n.listAttributes)}(n,t)})),r},Cn=function(e,n,t){var r,o=function(e,n,t){for(var r=[],o=0;o<t;o++)r.push(Sn(e,n.listType))
...
var r,o,i,u
x(e).each((function(e){Te(e.list,n.listAttributes),Te(e.item,n.itemAttributes),Ie(e.item,n.content)}))}(o,t),r=o,vn(x(n),k(r),yn),n.concat(o)},Nn=function(e){return ge(e,"OL,UL")},On=function(e){return Ae(e).map(Nn).getOr(!1)},Ln=function(e){return e.depth>0},Tn=function(e){return e.isSelected},Dn=function(e){var n=ke(e),t=Ee(e).map(Nn).getOr(!1)?n.slice(0,-1):n
return S(t,Me)},wn=function(e){return b(e,(function(n,t){(function(e,n){var t=e[n].depth,r=function(e){return e.depth===t&&!e.dirty},o=function(e){return e.depth<t}
return O(D(e.slice(0,n)),r,o).orThunk((function(){return O(e.slice(n+1),r,o)}))})(e,t).fold((function(){n.dirty&&function(e){e.listAttributes=Ne(e.listAttributes,(function(e,n){return"start"!==n}))}(n)}),(function(e){return r=e,(t=n).listType=r.listType,void(t.listAttributes=A({},r.listAttributes))
var t,r}))})),e},kn=function(e,n,t,r){return Ae(r).filter(Nn).fold((function(){n.each((function(e){me(e.start,r)&&t.set(!0)}))
var o=function(e,n,t){return we(e).filter(Le).map((function(r){return{depth:n,dirty:!1,isSelected:t,content:Dn(e),itemAttributes:De(e),listAttributes:De(r),listType:Oe(r)}}))}(r,e,t.get())
n.each((function(e){me(e.end,r)&&t.set(!1)}))
var i=Ee(r).filter(Nn).map((function(r){return xn(e,n,t,r)})).getOr([])
return o.toArray().concat(i)}),(function(r){return xn(e,n,t,r)}))},xn=function(e,n,t,r){return T(ke(r),(function(r){return(Nn(r)?xn:kn)(e+1,n,t,r)}))},An=function(e,n){var t=wn(n)
return S(t,(function(n){var t,r,o,i=(t=n.content,o=(r||document).createDocumentFragment(),b(t,(function(e){o.appendChild(e.dom)})),le.fromDom(o))
return le.fromDom(en(e,i.dom))}))},En=function(e,n){var t=wn(n)
return function(e,n){var t=N(n,(function(n,t){return t.depth>n.length?Cn(e,n,t):bn(e,n,t)}),[])
return k(t).map((function(e){return e.list}))}(e.contentDocument,t).toArray()},Pn=function(e,n,t){var o=function(e,n){var t,r=(t=!1,{get:function(){return t},set:function(e){t=e}})
return S(e,(function(e){return{sourceList:e,entries:xn(0,n,r,e)}}))}(n,function(e){var n=S(fn(e),le.fromDom)
return vn(L(n,r(On)),L(D(n),r(On)),(function(e,n){return{start:e,end:n}}))}(e))
b(o,(function(n){(function(e,n){b(C(e,Tn),(function(e){return function(e,n){switch(e){case"Indent":n.depth++
break
case"Outdent":n.depth--
break
case"Flatten":n.depth=0}n.dirty=!0}(n,e)}))})(n.entries,t)
var r,o=function(e,n){return T(function(e,n){if(0===e.length)return[]
for(var t=n(e[0]),r=[],o=[],i=0,u=e.length;i<u;i++){var a=e[i],s=n(a)
s!==t&&(r.push(o),o=[]),t=s,o.push(a)}return 0!==o.length&&r.push(o),r}(n,Ln),(function(n){return k(n).map(Ln).getOr(!1)?En(e,n):An(e,n)}))}(e,n.entries)
b(o,(function(n){gn(e,"Indent"===t?"IndentList":"OutdentList",n.dom)})),r=n.sourceList,b(o,(function(e){Pe(r,e)})),Re(n.sourceList)}))},Bn=function(e,n){var t=S(mn(e),le.fromDom),r=S(function(e){return C(fn(e),Qe)}(e),le.fromDom),o=!1
...
return t(!0),e.collapsed||t(),n},Hn=function(e){var n=function(n){var t,r,o
...
1===n.nodeType&&"bookmark"===n.getAttribute("data-mce-type")||t++,n=n.nextSibling}return-1}(t),t=t.parentNode,_n.remove(o),!t.hasChildNodes()&&_n.isBlock(t)&&t.appendChild(_n.create("br"))),e[n?"startContainer":"endContainer"]=t,e[n?"startOffset":"endOffset"]=r)}
n(!0),n()
var t=_n.createRng()
...
case"DL":return"ToggleDLList"}},jn=function(e){return/\btox\-/.test(e.className)},qn=function(e,n,t){var r=function(e){var r=O(e.parents,qe,Xe).filter((function(e){return e.nodeName===n&&!jn(e)})).isSome()
...
var a=Fn(r),s=function(e,n,t){for(var r,o=[],i=e.dom,u=Wn(e,n,!0,t),a=Wn(e,n,!1,t),s=[],c=u;c&&(s.push(c),c!==a);c=c.nextSibling);return Fe.each(s,(function(n){if(Ye(e,n))return o.push(n),void(r=null)
if(i.isBlock(n)||ze(n))return ze(n)&&i.remove(n),void(r=null)
var u=n.nextSibling
Un.isBookmarkNode(n)&&(qe(u)||Ye(e,u)||!u&&n.parentNode===t)?r=null:(r||(r=i.create("p"),n.parentNode.insertBefore(r,n),o.push(r)),r.appendChild(n))})),o}(e,r,i)
Fe.each(s,(function(r){var i,a=r.previousSibling,s=r.parentNode
We(s)||(a&&qe(a)&&a.nodeName===n&&function(e,n,t){var r=e.getStyle(n,"list-style-type"),o=t?t["list-style-type"]:""
...
e.remove(t)}},Yn=function(e,n,t,r,o){var i=qe(n)
if(i&&n.nodeName===r&&!Gn(o))Mn(e)
else{Qn(e,r,o)
var u=Fn(e.selection.getRng(!0)),a=i?function(){for(var e=0,n=0,t=arguments.length;n<t;n++)e+=arguments[n].length
var r=Array(e),o=0
for(n=0;n<t;n++)for(var i=arguments[n],u=0,a=i.length;u<a;u++,o++)r[o]=i[u]
return r}([n],t):t
Fe.each(a,(function(n){(function(e,n,t,r){if(n.nodeName!==t){var o=e.dom.rename(n,t)
Vn(e.dom,o,r),gn(e,$n(t),o)}else Vn(e.dom,n,r),gn(e,$n(t),n)})(e,n,r,o)})),e.selection.setRng(Hn(u))}},Gn=function(e){return"list-style-type"in e},Jn=function(e,n,t){var r=sn(e),o=cn(e)
t=t||{},o.length>0?Yn(e,r,o,n,t):function(e,n,t,r){if(n!==e.getBody())if(n)if(n.nodeName!==t||Gn(r)||jn(n)){var o=Fn(e.selection.getRng(!0))
Vn(e.dom,n,r)
var i=e.dom.rename(n,t)
zn(e.dom,i),e.selection.setRng(Hn(o)),Qn(e,t,r),gn(e,$n(t),i)}else Mn(e)
...
e.remove(n),b(u,(function(n){Je(e,n)&&n!==e.getRoot()&&e.remove(n)}))}},it=function(e,n,t,r){var o=e.dom
if(o.isEmpty(r))(function(e,n,t){e.dom.$(t).empty(),ot(e.dom,n,t),e.selection.setCursorLocation(t,0)})(e,t,r)
else{var i=Fn(n)
...
e.add("lists",(function(e){return!1===e.hasPlugin("rtc",!0)&&(dt(e),function(e){e.on("BeforeExecCommand",(function(n){var t=n.command.toLowerCase()
