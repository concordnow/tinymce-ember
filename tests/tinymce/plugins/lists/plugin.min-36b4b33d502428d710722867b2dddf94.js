...
return i||(i=!0,o=r.apply(null,e)),o}),ce=function(e){if(null==e)throw new Error("Node cannot be null or undefined")
return{dom:e}},fe=function(e,t){var n=(t||document).createElement(e)
return ce(n)},de=ce,le=function(e,t){return e.dom===t.dom},me=function(e,t){return se().browser.isIE()?function(e,t){return n=e.dom,r=t.dom,o=Node.DOCUMENT_POSITION_CONTAINED_BY,0!=(n.compareDocumentPosition(r)&o)
var n,r,o}(e,t):(n=t,(r=e.dom)!==(o=n.dom)&&r.contains(o))
var n,r,o},pe=function(e,t){var n=e.dom
...
throw new Error("Browser lacks native selectors")},ge=tinymce.util.Tools.resolve("tinymce.dom.RangeUtils"),ve=tinymce.util.Tools.resolve("tinymce.dom.TreeWalker"),he=tinymce.util.Tools.resolve("tinymce.util.VK"),ye=Object.keys,Se=function(e,t){for(var n=ye(e),r=0,o=n.length;r<o;r++){var i=n[r]
t(e[i],i)}},be=function(e,t){var n,r,o,i,a={}
return n=t,i=a,r=function(e,t){i[t]=e},o=u,Se(e,(function(e,t){(n(e,t)?r:o)(e,t)})),a},Ce=("undefined"!=typeof window||Function("return this;")(),function(e){return e.dom.nodeName.toLowerCase()}),Oe=(1,function(e){return 1===e.dom.nodeType}),Ne=function(e,t){var n=e.dom
Se(t,(function(e,t){!function(e,t,n){if(!(y(n)||b(n)||O(n)))throw console.error("Invalid call to Attribute.set. Key ",t,":: Value ",n,":: Element ",e),new Error("Attribute value was not simple")
e.setAttribute(t,n+"")}(n,t,e)}))},Le=function(e){return A(e.dom.attributes,(function(e,t){return e[t.name]=t.value,e}),{})},Te=function(e){return g.from(e.dom.parentNode).map(de)},ke=function(e){return T(e.dom.childNodes,de)},xe=function(e,t){var n=e.dom.childNodes
return g.from(n[t]).map(de)},Ae=function(e){return xe(e,0)},De=function(e){return xe(e,e.dom.childNodes.length-1)},we=function(e,t){Te(e).each((function(n){n.dom.insertBefore(t.dom,e.dom)}))},Ee=function(e,t){e.dom.appendChild(t.dom)},Be=function(e,t){k(t,(function(t){Ee(e,t)}))},Ie=function(e){var t=e.dom
null!==t.parentNode&&t.parentNode.removeChild(t)},Pe=function(e){return!0,de(e.dom.cloneNode(true))},Re=function(e,t){var n,r,o,i=(n=e,r=fe(t),o=Le(n),Ne(r,o),r)
we(e,i)
var a=ke(e)
...
s=(r=e,o=n.itemAttributes,i=n.content,a=fe("li",r),Ne(a,o),Be(a,i),a),Ee((u=t).list,s),u.item=s,f=n,Ce((c=t).list)!==f.listType&&(c.list=Re(c.list,f.listType)),Ne(c.list,f.listAttributes)})),r},pt=function(e,t,n){var r,o=function(e,t,n){for(var r,o,i,a=[],u=0;u<n;u++)a.push((r=e,o=t.listType,i={list:fe(o,r),item:fe("li",r)},Ee(i.list,i.item),i))
...
R(e).each((function(e){Ne(e.list,t.listAttributes),Ne(e.item,t.itemAttributes),Be(e.item,t.content)}))}(o,n),r=o,ct(R(t),P(r),lt),t.concat(o)},gt=function(e){return pe(e,"OL,UL")},vt=function(e){return Ae(e).map(gt).getOr(!1)},ht=function(e){return 0<e.depth},yt=function(e){return e.isSelected},St=function(e){var t=ke(e),n=De(e).map(gt).getOr(!1)?t.slice(0,-1):t
return T(n,Pe)},bt=function(e){return k(e,(function(t,n){var r,o,i,a,u
i=(r=e)[o=n].depth,a=function(e){return e.depth===i&&!e.dirty},u=function(e){return e.depth<i},D(B(r.slice(0,o)),a,u).orThunk((function(){return D(r.slice(o+1),a,u)})).fold((function(){var e
t.dirty&&((e=t).listAttributes=be(e.listAttributes,(function(e,t){return"start"!==t})))}),(function(e){return r=e,(n=t).listType=r.listType,void(n.listAttributes=M({},r.listAttributes))
var n,r}))})),e},Ct=function(e,t,n,r){return Ae(r).filter(gt).fold((function(){t.each((function(e){le(e.start,r)&&n.set(!0)}))
...
t.each((function(e){le(e.end,r)&&n.set(!1)}))
...
return T(n,(function(t){var n,r,o=(n=t.content,r=document.createDocumentFragment(),k(n,(function(e){r.appendChild(e.dom)})),de(r))
return de(Je(e,o.dom))}))},Lt=function(e,t){var n,r,o=bt(t)
...
return T(e,(function(e){return{sourceList:e,entries:Ot(0,t,r,e)}}))}(t,(r=T(it(e),de),ct(w(r,c(vt)),w(B(r),c(vt)),(function(e,t){return{start:e,end:t}}))))
...
return st(e,o)}(e),de),i=T(x(it(e),Ve),de),a=!1
return(o.length||i.length)&&(n=e.selection.getBookmark(),Tt(e,o,t),r=e,k(i,"Indent"===t?et:function(e){return function(e,t){pe(t,"dd")?Re(t,"dt"):pe(t,"dt")&&Te(t).each((function(n){return function(e,t,n){var r=Ze.select('span[data-mce-type="bookmark"]',t),o=Je(e,n),i=Ze.createRng()
...
return n(!0),e.collapsed||n(),t},It=function(e){var t=function(t){var n,r=n=e[t?"startContainer":"endContainer"],o=e[t?"startOffset":"endOffset"]
r&&(1===r.nodeType&&(o=function(e){for(var t=e.parentNode.firstChild,n=0;t;){if(t===e)return n
1===t.nodeType&&"bookmark"===t.getAttribute("data-mce-type")||n++,t=t.nextSibling}return-1}(r),r=r.parentNode,Et.remove(n),!r.hasChildNodes()&&Et.isBlock(r)&&r.appendChild(Et.create("br"))),e[t?"startContainer":"endContainer"]=r,e[t?"startOffset":"endOffset"]=o)}
t(!0),t()
var n=Et.createRng()
...
o=o.parentNode}return o},$t=function(e,t,n){void 0===n&&(n={})
var r,o,i=e.selection.getRng(),a="LI",u=at(e,e.selection.getStart(!0)),s=e.dom
"false"!==s.getContentEditable(e.selection.getNode())&&("DL"===(t=t.toUpperCase())&&(a="DT"),r=Bt(i),o=function(e,t,n){for(var r,o=[],i=e.dom,a=Ft(e,t,!0,n),u=Ft(e,t,!1,n),s=[],c=a;c&&(s.push(c),c!==u);c=c.nextSibling);return Ue.each(s,(function(t){if(Xe(e,t))return o.push(t),void(r=null)
if(i.isBlock(t)||Qe(t))return Qe(t)&&i.remove(t),void(r=null)
var a=t.nextSibling
wt.isBookmarkNode(t)&&(je(a)||Xe(e,a)||!a&&t.parentNode===n)?r=null:(r||(r=i.create("p"),t.parentNode.insertBefore(r,t),o.push(r)),r.appendChild(t))})),o}(e,i,u),Ue.each(o,(function(r){var o,i,u,c,f,d,l,m=r.previousSibling,p=r.parentNode
Ke(p)||(m&&je(m)&&m.nodeName===t&&(f=m,d=n,s.getStyle(f,"list-style-type")===(l=null===(l=d?d["list-style-type"]:"")?"":l))?(o=m,r=s.rename(r,a),m.appendChild(r)):(o=s.create(t),r.parentNode.insertBefore(o,r),o.appendChild(r),r=s.rename(r,a)),i=s,u=r,c=["margin","margin-right","margin-bottom","margin-left","margin-top","padding","padding-right","padding-bottom","padding-left","padding-top"],Ue.each(c,(function(e){var t
return i.setStyle(u,((t={})[e]="",t))})),_t(s,o,n),qt(e.dom,o))})),e.selection.setRng(It(r)))},jt=function(e,t,n){return s=n,(u=t)&&s&&je(u)&&u.nodeName===s.nodeName&&(i=t,a=n,(o=e).getStyle(i,"list-style-type",!0)===o.getStyle(a,"list-style-type",!0))&&(r=n,t.className===r.className)
var r,o,i,a,u,s},qt=function(e,t){var n,r=t.nextSibling
if(jt(e,t,r)){for(;n=r.firstChild;)t.appendChild(n)
e.remove(r)}if(r=t.previousSibling,jt(e,t,r)){for(;n=r.lastChild;)t.insertBefore(n,t.firstChild)
e.remove(r)}},Ht=function(e){return"list-style-type"in e},Kt=function(e,t,n){var r,o,i,a,u,s,c=ot(e),f=function(e){var t,n,r,o=ot(e),i=e.selection.getSelectedBlocks()
...
n=n||{},0<f.length?function(e,t,n,r,o){var i,a,u=je(t)
u&&t.nodeName===r&&!Ht(o)?Dt(e):($t(e,r,o),i=Bt(e.selection.getRng(!0)),a=u?function(){for(var e=0,t=0,n=arguments.length;t<n;t++)e+=arguments[t].length
var r=Array(e),o=0
for(t=0;t<n;t++)for(var i=arguments[t],a=0,u=i.length;a<u;a++,o++)r[o]=i[a]
return r}([t],n):n,Ue.each(a,(function(t){var n,i,a,u,s
n=e,a=r,u=o,(i=t).nodeName!==a?(s=n.dom.rename(i,a),_t(n.dom,s,u),ft(n,Pt(a),s)):(_t(n.dom,i,u),ft(n,Pt(a),i))})),e.selection.setRng(It(i)))}(e,c,f,t,n):(i=t,a=n,(o=c)!==(r=e).getBody()&&(o?o.nodeName!==i||Ht(a)||Rt(o)?(u=Bt(r.selection.getRng(!0)),_t(r.dom,o,a),s=r.dom.rename(o,i),qt(r.dom,s),r.selection.setRng(It(u)),$t(r,i,a),ft(r,Pt(i),s)):Dt(r):($t(r,i,a),ft(r,Pt(i),o))))},Vt=Me.DOM,Wt=function(e,t,n,r){var o=t.startContainer,i=t.startOffset
if($e(o)&&(n?i<o.data.length:0<i))return o
var a=e.schema.getNonEmptyElements()
1===o.nodeType&&(o=ge.getNode(o,i))
var u,s,c=new ve(o,r)
...
if($e(o)&&0<o.data.length)return o}},Qt=function(e,t){var n=t.childNodes
return 1===n.length&&!je(n[0])&&e.isBlock(n[0])},Xt=function(e,t,n){var r,o,i,a=t.parentNode
Ge(e,t)&&Ge(e,n)&&(je(n.lastChild)&&(r=n.lastChild),a===n.lastChild&&Qe(a.previousSibling)&&e.remove(a.previousSibling),(o=n.lastChild)&&Qe(o)&&t.hasChildNodes()&&e.remove(o),Ye(e,n,!0)&&e.$(n).empty(),function(e,t,n){var r,o,i,a=Qt(e,n)?n.firstChild:n
if(Qt(o=e,i=t)&&o.remove(i.firstChild,!0),!Ye(e,t,!0))for(;r=t.firstChild;)a.appendChild(r)}(e,t,n),r&&n.appendChild(r),i=me(de(n),de(t))?e.getParents(t,je,n):[],e.remove(t),k(i,(function(t){Ye(e,t)&&t!==e.getRoot()&&e.remove(t)})))},zt=function(e,t){var n=e.dom,r=e.selection,o=r.getStart(),i=at(e,o),a=n.getParent(r.getStart(),"LI",i)
if(a){var u=a.parentNode
if(u===e.getBody()&&Ye(n,u))return!0
var s=nt(r.getRng()),c=n.getParent(Wt(e,s,t,i),"LI",i)
if(c&&c!==a)return e.undoManager.transact((function(){var n
t?function(e,t,n,r){var o,i,a,u,s=e.dom
s.isEmpty(r)?(a=n,u=r,(i=e).dom.$(u).empty(),Xt(i.dom,a,u),i.selection.setCursorLocation(u,0)):(o=Bt(t),Xt(s,n,r),e.selection.setRng(It(o)))}(e,s,c,a):(n=a).parentNode.firstChild===n?At(e):function(e,t,n,r){var o=Bt(t)
Xt(e.dom,n,r)
var i=It(o)
e.selection.setRng(i)}(e,s,a,c)})),!0
if(!c&&!t&&0===s.startOffset&&0===s.endOffset)return e.undoManager.transact((function(){Dt(e)})),!0}return!1},Yt=function(e,t){return e.selection.isCollapsed()?zt(i=e,a=t)||function(e,t){var n=e.dom,r=e.selection.getStart(),o=at(e,r),i=n.getParent(r,n.isBlock,o)
if(i&&n.isEmpty(i)){var a=nt(e.selection.getRng()),u=n.getParent(Wt(e,a,t,o),"LI",o)
if(u)return e.undoManager.transact((function(){var r,a,s,c
a=i,s=o,c=(r=n).getParent(a.parentNode,r.isBlock,s),r.remove(a),c&&r.isEmpty(c)&&r.remove(c),qt(n,u.parentNode),e.selection.select(u,!0),e.selection.collapse(t)})),!0}return!1}(i,a):(r=(n=e).selection.getStart(),o=at(n,r),!!(n.dom.getParent(r,"LI,DT,DD",o)||0<it(n).length)&&(n.undoManager.transact((function(){n.execCommand("Delete"),function(e,t){Ue.each(Ue.grep(e.select("ol,ul",t)),(function(t){var n,r,o,i
n=e,"LI"===(i=(r=t).parentNode).nodeName&&i.firstChild===r&&((o=i.previousSibling)&&"LI"===o.nodeName?(o.appendChild(r),Ye(n,i)&&Vt.remove(i)):Vt.setStyle(i,"listStyleType","none")),je(i)&&(o=i.previousSibling)&&"LI"===o.nodeName&&o.appendChild(r)}))}(n.dom,n.getBody())})),!0))
var n,r,o,i,a},Gt=function(e){var t=e.dom,n=ot(e)
...
e.undoManager.transact((function(){t.setAttrib(ot(e),"start","1"===r.start?"":r.start)})),n.close()}})},Jt=function(e,t){return function(){var n=e.dom.getParent(e.selection.getStart(),"UL,OL,DL")
...
return He(t)?["listprops"]:[]}}),a=e,{backspaceDelete:function(e){Yt(a,e)}}}))}()
