...
r.setEditorInterval(t,(function(){c(t)}),e)},v=function(t){t.undoManager.transact((function(){m(t),f(t)})),t.focus()},d=tinymce.util.Tools.resolve("tinymce.EditorManager"),g=function(t){return function(e){e.setDisabled(!s(t))
