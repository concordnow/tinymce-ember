...
throw new Error("Browser lacks native selectors")},H=function(n){return C(n.dom.ownerDocument)},R=function(n){return F(n.dom.childNodes,C)},V=b(Element.prototype.attachShadow)&&b(Node.prototype.getRootNode),W=i(V),B=V?function(n){return C(n.dom.getRootNode())}:function(n){return q(n)?n:H(n)},j=function(n){var e,t=B(n)
return D(e=t)&&w(e.dom.host)?d.some(t):d.none()},z=function(n){return C(n.dom.host)},I=function(n){var e=P(n)?n.dom.parentNode:n.dom
