...
return n[o].apply(null,r)},match:function(t){var e=R(t)
if(n.length!==e.length)throw new Error("Wrong number of arguments to match. Expected: "+n.join(",")+"\nActual: "+e.join(","))
if(!x(n,(function(t){return k(e,t)})))throw new Error("Not all branches were specified when using match. Specified: "+e.join(", ")+"\nRequired: "+n.join(", "))
return t[i].apply(null,r)},log:function(t){console.log(t,{constructors:n,constructor:i,params:r})}}}}))}([{bothErrors:["error1","error2"]},{firstError:["error1","value2"]},{secondError:["value1","error2"]},{bothValues:["value1","value2"]}]),function(t){var n=[],r=[]
...
var n,r,e},A=function(t){var n=function(n){return M.error({message:n,pattern:t})},r=function(r,e,o){if(void 0===t.format)return void 0!==t.cmd?p(t.cmd)?M.value(o(t.cmd,t.value)):n(r+" pattern has non-string `cmd` parameter"):n(r+" pattern is missing both `format` and `cmd` parameters")
var a=void 0
...
n.deleteContents(),e&&!r(n.startContainer)&&(X(n.startContainer)&&0===n.startContainer.data.length&&t.remove(n.startContainer),X(n.endContainer)&&0===n.endContainer.data.length&&t.remove(n.endContainer),z(t,o,r),o!==a&&z(t,a,r))},Y=function(t,n){var r=n.get(t)
return v(r)&&function(t){return n=t,0<n.length?m.some(n[0]):m.none()
var n}(r).exists((function(t){return n=t,"block",T.call(n,"block")
var n}))},Z=function(t){return 0===t.start.length},$=function(t,n){var r=m.from(t.dom.getParent(n.startContainer,t.dom.isBlock))
return""===V(t)?r.orThunk((function(){return m.some(t.getBody())})):r},tt=H.DOM,nt=function(t){return function(n){return t===n?-1:0}},rt=function(t,n,r){if(X(t)&&0<=n)return m.some(K(t,n))
var e=J(tt)
return m.from(e.backwards(t,n,nt(t),r)).map((function(t){return K(t.container,t.container.data.length)}))},et=function(t,n,r){if(!X(t))return m.none()
var e=t.textContent
if(0<=n&&n<=e.length)return m.some(K(t,n))
var o=J(tt)
return m.from(o.backwards(t,n,nt(t),r)).bind((function(t){var e=t.container.data
return et(t.container,n+e.length,r)}))},ot=function(t,n,r){if(!X(t))return m.none()
var e=t.textContent
if(n<=e.length)return m.some(K(t,n))
var o=J(tt)
return m.from(o.forwards(t,n,nt(t),r)).bind((function(t){return ot(t.container,n-e.length,r)}))},at=function(t,n,r){if(X(n)&&(r<0||r>n.data.length))return[]
for(var e=[r],o=n;o!==t&&o.parentNode;){for(var a=o.parentNode,i=0;i<a.childNodes.length;i++)if(a.childNodes[i]===o){e.push(i)
break}o=a}return o===t?e.reverse():[]},it=function(t,n,r,e,o){return{start:at(t,n,r),end:at(t,e,o)}},ut=function(t,n){var r,e,o,a=n.slice(),i=a.pop()
return(r=a,e=function(t,n){return t.bind((function(t){return m.from(t.childNodes[n])}))},o=m.some(t),w(r,(function(t){o=e(o,t)})),o).bind((function(t){return X(t)&&(i<0||i>t.data.length)?m.none():m.some({node:t,offset:i})}))},ft=function(t,n){return ut(t,n.start).bind((function(r){var e=r.node,o=r.offset
return ut(t,n.end).map((function(t){var n=t.node,r=t.offset,a=document.createRange()
return a.setStart(e,o),a.setEnd(n,r),a}))}))},ct=function(t,n,r){(function(t,n,r){if(X(t)&&0>=t.length)return m.some(K(t,0))
var e=J(tt)
return m.from(e.forwards(t,0,nt(t),r)).map((function(t){return K(t.container,0)}))})(n,0,n).each((function(e){var o=e.container
ot(o,r.start.length,n).each((function(r){var e=t.createRng()
e.setStart(o,0),e.setEnd(r.container,r.offset),Q(t,e,(function(t){return t===n}))}))}))},st=function(t,n){var r=t.dom,e=t.selection.getRng()
return $(t,e).filter((function(n){var e=V(t),o=""===e&&r.is(n,"body")||r.is(n,e)
...
if(r(a,e))break}return m.none()}(t,n,f)}(e,(function(t){return 0===o.indexOf(t.start)||0===a.indexOf(t.start)}))).map((function(n){return G.trim(i).length===n.start.length?[]:[{pattern:n,range:it(r.getRoot(),t,0,t,0)}]}))})).getOr([])},lt=0,dt=function(t,n){return t.create("span",{"data-mce-type":"bookmark",id:n})},mt=function(t,n){var r=t.createRng()
return r.setStartAfter(n.start),r.setEndBefore(n.end),r},gt=function(t,n,r){var e=ft(t.getRoot(),r).getOrDie("Unable to resolve path range"),o=e.startContainer,a=e.endContainer,i=0===e.endOffset?a:a.splitText(e.endOffset),u=0===e.startOffset?o:o.splitText(e.startOffset)
...
return et(e.container,i,r).map((function(n){var r=t.createRng()
...
return et(i,u-r.pattern.end.length,n).bind((function(f){var c=it(o,f.container,f.offset,i,u)
if(Z(a))return m.some({matches:[{pattern:a,startRng:c,endRng:c}],position:f})
var s=yt(t,r.remainingPatterns,f.container,f.offset,n),l=s.getOr({matches:[],position:f}),d=l.position
return function(t,n,r,e,o,a){if(void 0===a&&(a=!1),0!==n.start.length||a)return rt(r,e,o).bind((function(r){return ht(t,n,o,r).bind((function(t){if(a){if(t.endContainer===r.container&&t.endOffset===r.offset)return m.none()
if(0===r.offset&&t.endContainer.textContent.length===t.endOffset)return m.none()}return m.some(t)}))}))
var i=t.createRng()
return i.setStart(r,e),i.setEnd(r,e),m.some(i)}(e,a,d.container,d.offset,n,s.isNone()).map((function(t){var n,r=it(o,(n=t).startContainer,n.startOffset,n.endContainer,n.endOffset)
...
return rt(r,e,a.getRoot()).bind((function(i){var u=a.createRng()
...
return!1===e.collapsed?[]:$(t,e).bind((function(o){var a=e.startOffset-(r?1:0)
...
return E(a,(function(n,r){var i=a.length-n.length-1,u=Z(r.pattern)?r.endMarker:gt(t,e+"_start"+i,r.startRng)
...
Z(n.pattern)?(e=t,o=n.pattern,a=n.endMarker,i=c,u=mt(e.dom,a),Q(e.dom,u,i),bt(e,o,u)):function(t,n,r,e,o){var a=t.dom,i=mt(a,e),u=mt(a,r)
Q(a,u,o),Q(a,i,o)
...
0<r.length&&t.undoManager.transact((function(){Ot(t,r)}))},Ct=function(t,n,r){for(var e=0;e<t.length;e++)if(r(t[e],n))return!0},Et=function(t,n){var r=[",",".",";",":","!","?"],e=[32]
t.on("keydown",(function(r){13!==r.keyCode||F.modifierPressed(r)||!function(t,n){if(!t.selection.isCollapsed())return!1
var r=kt(t,n.inlinePatterns,!1),e=st(t,n.blockPatterns)
return(0<e.length||0<r.length)&&(t.undoManager.add(),t.undoManager.extra((function(){t.execCommand("mceInsertNewLine")}),(function(){t.insertContent("\ufeff"),Ot(t,r),function(t,n){var r
0!==n.length&&(r=t.selection.getBookmark(),w(n,(function(n){return e=n,o=(r=t).dom,a=e.pattern,i=ft(o.getRoot(),e.range).getOrDie("Unable to resolve path range"),$(r,i).each((function(t){"block-format"===a.type?Y(a.format,r.formatter)&&r.undoManager.transact((function(){ct(r.dom,t,a),r.formatter.apply(a.format)})):"block-command"===a.type&&r.undoManager.transact((function(){ct(r.dom,t,a),r.execCommand(a.cmd,!1,a.value)}))})),1
var r,e,o,a,i})),t.selection.moveToBookmark(r))}(t,e)
var n=t.selection.getRng(),o=rt(n.startContainer,n.startOffset,t.dom.getRoot())
t.execCommand("mceInsertNewLine"),o.each((function(n){var r=n.container
"\ufeff"===r.data.charAt(n.offset-1)&&(r.deleteData(n.offset-1,1),z(t.dom,r.parentNode,(function(n){return n===t.dom.getRoot()})))}))})),!0)}(t,n.get())||r.preventDefault()}),!0),t.on("keyup",(function(r){Ct(e,r,(function(t,n){return t===n.keyCode&&!1===F.modifierPressed(n)}))&&wt(t,n.get())})),t.on("keypress",(function(e){Ct(r,e,(function(t,n){return t.charCodeAt(0)===n.charCode}))&&W.setEditorTimeout(t,(function(){wt(t,n.get())}))}))}
...
return Et(t,e),function(t){return{setPatterns:function(n){var r=N(O(n,A))
