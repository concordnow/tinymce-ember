...
if(l)l.fullscreenChangeHandler.unbind(),Yn(n)&&Jn(f)&&(t=yn(f),(o=t.dom).exitFullscreen?o.exitFullscreen():o.msExitFullscreen?o.msExitFullscreen():o.webkitCancelFullScreen&&o.webkitCancelFullScreen()),h.width=l.iframeWidth,h.height=l.iframeHeight,v.width=l.containerWidth,v.height=l.containerHeight,v.top=l.containerTop,v.left=l.containerLeft,p(),r=l.scrollPos,window.scrollTo(r.x,r.y),e.set(null),Kn(n,!1),n.off("remove",p)
