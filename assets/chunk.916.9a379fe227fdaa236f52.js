/*! For license information please see chunk.916.9a379fe227fdaa236f52.js.LICENSE.txt */
...
function h(e){return(h="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function p(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function g(e,t){for(var n=0;n<t.length;n++){var r=t[n]
...
return n.pop(),s}return"string"===o?i:"[ERROR: Missing QUnit.dump formatter for type "+t+"]"},typeOf:function(e){return null===e?"null":void 0===e?"undefined":_("regexp",e)?"regexp":_("date",e)?"date":_("function",e)?"function":void 0!==e.setInterval&&void 0!==e.document&&void 0===e.nodeType?"window":9===e.nodeType?"document":e.nodeType?"node":function(e){return"[object Array]"===x.call(e)||"number"==typeof e.length&&void 0!==e.item&&(e.length?e.item(0)===e[0]:null===e.item(0)&&void 0===e[0])}(e)?"array":e.constructor===Error.prototype.constructor?"error":h(e)},separator:function(){return this.multiline?this.HTML?"<br />":"\n":this.HTML?"&#160;":" "},indent:function(e){if(!this.multiline)return""
...
G(e,t,n,{ignored:Y&&(r=H.modules.filter((function(e){return!e.ignored})).map((function(e){return e.moduleId})),!F.some((function(e){return r.includes(e.moduleId)})))})}W.only=function(){Y||(H.modules.length=0,H.queue.length=0,H.currentModule.ignored=!0),Y=!0,G.apply(void 0,arguments)},W.skip=function(e,t,n){Y||G(e,t,n,{skip:!0})},W.todo=function(e,t,n){Y||G(e,t,n,{todo:!0})}
...
H.pollution.push(e)}}ge.count=0,ge.prototype={get stack(){return V(this.errorForStack,this.stackOffset)},before:function(){var e=this,t=this.module
return function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t).reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:T()},re("suiteStart",t.suiteReport.start(!0)),ae("moduleStart",{name:t.name,tests:t.tests})}))}),se.resolve([])).then((function(){return H.current=e,e.testEnvironment=I({},t.testEnvironment),e.started=T(),re("testStart",e.testReport.start(!0)),ae("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){H.pollution||ve()}))}))},run:function(){if(H.current=this,this.callbackStarted=T(),H.notrycatch)e(this)
...
break
default:n=e}return n}var Be={console:_e,tap:function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
function Qe(e){return function(t){H.globalHooks[e]||(H.globalHooks[e]=[]),H.globalHooks[e].push(t)}}var ze={beforeEach:Qe("beforeEach"),afterEach:Qe("afterEach")}
function $e(e){H.current?H.current.assert.pushResult({result:!1,message:"global failure: ".concat(A(e)),source:e&&e.stack||Z(2)}):(B.globalFailureCount++,H.stats.bad++,H.stats.all++,re("error",e))}var Ge={}
H.currentModule.suiteReport=B
var Ye=!1,We=!1
function Je(){We=!0,a?a((function(){Ze()})):Ze()}function Ve(){H.blocking=!1,he.advance()}function Ze(){if(H.started)Ve()
...
re("runStart",B.start(!0)),ae("begin",{totalTests:ge.count,modules:t}).then(Ve)}}Ge.isLocal=o&&o.location&&"file:"===o.location.protocol,Ge.version="2.18.1",I(Ge,{config:H,dump:U,equiv:L,reporters:Be,hooks:ze,is:_,objectType:R,on:function(e,t){if("string"!==R(e))throw new TypeError("eventName must be a string when registering a listener")
...
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,$e(t),!1},onUncaughtException:$e,pushFailure:me,assert:K.prototype,module:W,test:we,todo:we.todo,skip:we.skip,only:we.only,start:function(e){if(H.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=Ye
...
if(!H.pageLoaded)return H.autostart=!0,void(l||Ge.load())
...
return I.apply(this,t)},load:function(){H.pageLoaded=!0,I(H,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),We||(H.blocking=!1,H.autostart&&Je())},stack:function(e){return Z(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
"undefined"===R(H.callbacks[o])&&(H.callbacks[o]=[]),e[o]=n(o)}}(Ge),function(i){if(o&&l){if(o.QUnit&&o.QUnit.version)throw new Error("QUnit has already been defined.")
o.QUnit=i}e&&e.exports&&(e.exports=i,e.exports.QUnit=i),t&&(t.QUnit=i),void 0===(r=function(){return i}.call(t,n,t,e))||(e.exports=r),i.config.autostart=!1}(Ge),function(){if(o&&l){var e=Ge.config,t=Object.prototype.hasOwnProperty
Ge.begin((function(){if(!t.call(e,"fixture")){var n=l.getElementById("qunit-fixture")
n&&(e.fixture=n.cloneNode(!0))}})),Ge.testStart((function(){if(null!=e.fixture){var t=l.getElementById("qunit-fixture")
...
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(o&&l){var e=Ge.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=C({filter:void 0,module:void 0,moduleId:void 0,testId:void 0})
Ge.on("runStart",(function(e){et.defined=e.testCounts.total})),Ge.begin((function(){var t,n,s,a,u,f,d,m,y,C,j;(f=w("qunit"))&&(f.setAttribute("role","main"),f.innerHTML="<h1 id='qunit-header'>"+tt(l.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(t=Ge.config.testId)||t.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+tt(t.join(", "))+" <a id='qunit-clearFilter' href='"+tt(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(n=w("qunit-header"))&&(n.innerHTML="<a href='"+tt(i)+"'>"+n.innerHTML+"</a> "),(s=w("qunit-banner"))&&(s.className=""),C=w("qunit-tests"),(j=w("qunit-testresult"))&&j.parentNode.removeChild(j),C&&(C.innerHTML="",(j=l.createElement("p")).id="qunit-testresult",j.className="result",C.parentNode.insertBefore(j,C),j.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',m=w("qunit-testresult-controls")),m&&m.appendChild(((y=l.createElement("button")).id="qunit-abort-tests-button",y.innerHTML="Abort",h(y,"click",x),y)),(a=w("qunit-userAgent"))&&(a.innerHTML="",a.appendChild(l.createTextNode("QUnit "+Ge.version+"; "+c.userAgent))),(u=w("qunit-testrunner-toolbar"))&&(u.appendChild(((d=l.createElement("span")).innerHTML=function(){for(var t=!1,n=e.urlConfig,i="",o=0;o<n.length;o++){var s=e.urlConfig[o]
...
e[s.id]&&!t&&(i+="<option value='"+(a=tt(e[s.id]))+"' selected='selected' disabled='disabled'>"+a+"</option>"),i+="</select>"}else i+="<label for='qunit-urlconfig-"+a+"' title='"+u+"'><input id='qunit-urlconfig-"+a+"' name='"+a+"' type='checkbox'"+(s.value?" value='"+tt(s.value)+"'":"")+(e[s.id]?" checked='checked'":"")+" title='"+u+"' />"+tt(s.label)+"</label>"}return i}(),v(d,"qunit-url-config"),g(d.getElementsByTagName("input"),"change",T),g(d.getElementsByTagName("select"),"change",T),d)),u.appendChild(function(){var t,n,r,i,s=l.createElement("span")
...
f?v(a,"qunit-collapsed"):(et.failedTests.push(r.testId),e.collapse&&(n?v(a,"qunit-collapsed"):n=!0))
var d=o.firstChild,p=c?"<b class='failed'>"+c+"</b>, <b class='passed'>"+u+"</b>, ":""
if(d.innerHTML+=" <b class='counts'>("+p+r.assertions.length+")</b>",et.completed++,r.skipped){o.className="skipped"
...
x.innerHTML="<strong>Source: </strong>"+tt(r.source),v(x,"qunit-source"),f&&v(x,"qunit-collapsed"),h(d,"click",(function(){b(x,"qunit-collapsed")})),o.appendChild(x)}e.hidepassed&&("passed"===s||r.skipped)&&(t.push(o),i.removeChild(o))}})),Ge.on("error",(function(e){var t=j("global failure")
if(t){var n=tt(A(e))
...
u&&s.warn("Support for PhantomJS is deprecated and will be removed in QUnit 3.0."),u||"complete"!==l.readyState?h(o,"load",Ge.load):Ge.load()
var f=o.onerror
...
for(var i in e=I(I({},Ge.urlParams),e))if(r.call(e,i)&&void 0!==e[i])for(var s=[].concat(e[i]),a=0;a<s.length;a++)t+=encodeURIComponent(i),!0!==s[a]&&(t+="="+encodeURIComponent(s[a])),t+="&"
...
n+="<li><label class='clickable"+(i?" checked":"")+"'><input type='checkbox' value='"+t[r].moduleId+"'"+(i?" checked='checked'":"")+" />"+tt(t[r].name)+"</label></li>"}return n}function j(e,t,n){var r=w("qunit-tests")
...
return a.className="qunit-assert-list",o.appendChild(a),r.appendChild(o),o}}function q(e){return 0===e.length?"":["<br /><a href='"+tt(C({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function M(e,t){var n=""
return t&&(n="<span class='module-name'>"+tt(t)+"</span>: "),n+"<span class='test-name'>"+tt(e)+"</span>"}function R(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function _(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),Ge.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
