...
return t.reverse(),t},I=function(e){return 0===e.length?g.none():g.some(e[0])},P=function(e){return 0===e.length?g.none():g.some(e[e.length-1])},R=function(){return(R=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var o in t=arguments[n])Object.prototype.hasOwnProperty.call(t,o)&&(e[o]=t[o])
return e}).apply(this,arguments)},M=function(){return U(0,0)},U=function(e,t){return{major:e,minor:t}},_=function(e,t){var n=String(t).toLowerCase()
return 0===e.length?M():function(e,t){var n=function(e,t){for(var n=0;n<e.length;n++){var r=e[n]
if(r.test(t))return r}}(e,t)
if(!n)return{major:0,minor:0}
var r=function(e){return Number(t.replace(n,"$"+e))}
return U(r(1),r(2))}(e,n)},F=M,$=function(e,t){var n=String(t).toLowerCase()
return w(e,(function(e){return e.search(n)}))},j=function(e,t){return-1!==e.indexOf(t)},q=/.*?version\/\ ?([0-9]+)\.([0-9]+).*/,H=function(e){return function(t){return j(t,e)}},K=[{name:"Edge",versionRegexes:[/.*?edge\/ ?([0-9]+)\.([0-9]+)$/],search:function(e){return j(e,"edge/")&&j(e,"chrome")&&j(e,"safari")&&j(e,"applewebkit")}},{name:"Chrome",versionRegexes:[/.*?chrome\/([0-9]+)\.([0-9]+).*/,q],search:function(e){return j(e,"chrome")&&!j(e,"chromeframe")}},{name:"IE",versionRegexes:[/.*?msie\ ?([0-9]+)\.([0-9]+).*/,/.*?rv:([0-9]+)\.([0-9]+).*/],search:function(e){return j(e,"msie")||j(e,"trident")}},{name:"Opera",versionRegexes:[q,/.*?opera\/([0-9]+)\.([0-9]+).*/],search:H("opera")},{name:"Firefox",versionRegexes:[/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/],search:H("firefox")},{name:"Safari",versionRegexes:[q,/.*?cpu os ([0-9]+)_([0-9]+).*/],search:function(e){return(j(e,"safari")||j(e,"mobile/"))&&j(e,"applewebkit")}}],V=[{name:"Windows",search:H("win"),versionRegexes:[/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/]},{name:"iOS",search:function(e){return j(e,"iphone")||j(e,"ipad")},versionRegexes:[/.*?version\/\ ?([0-9]+)\.([0-9]+).*/,/.*cpu os ([0-9]+)_([0-9]+).*/,/.*cpu iphone os ([0-9]+)_([0-9]+).*/]},{name:"Android",search:H("android"),versionRegexes:[/.*?android\ ?([0-9]+)\.([0-9]+).*/]},{name:"OSX",search:H("mac os x"),versionRegexes:[/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/]},{name:"Linux",search:H("linux"),versionRegexes:[]},{name:"Solaris",search:H("sunos"),versionRegexes:[]},{name:"FreeBSD",search:H("freebsd"),versionRegexes:[]},{name:"ChromeOS",search:H("cros"),versionRegexes:[/.*?chrome\/([0-9]+)\.([0-9]+).*/]}],W={browsers:s(K),oses:s(V)},Q="Edge",X="Chrome",z="Firefox",Y=function(e){var t=e.current,n=e.version,r=function(e){return function(){return t===e}}
return{current:t,version:n,isEdge:r(Q),isChrome:r(X),isIE:r("IE"),isOpera:r("Opera"),isFirefox:r(z),isSafari:r("Safari")}},G=function(){return Y({current:void 0,version:F()})},J=Y,Z=(s(Q),s(X),s("IE"),s("Opera"),s(z),s("Safari"),"Windows"),ee="Android",te="Solaris",ne="FreeBSD",re="ChromeOS",oe=function(e){var t=e.current,n=e.version,r=function(e){return function(){return t===e}}
return{current:t,version:n,isWindows:r(Z),isiOS:r("iOS"),isAndroid:r(ee),isOSX:r("OSX"),isLinux:r("Linux"),isSolaris:r(te),isFreeBSD:r(ne),isChromeOS:r(re)}},ie=function(){return oe({current:void 0,version:F()})},ae=oe,ue=(s(Z),s("iOS"),s(ee),s("Linux"),s("OSX"),s(te),s(ne),s(re),function(e,t){var n,r,o,i,a,u,c,f,d,l,m,p,g=W.browsers(),v=W.oses(),h=function(e,t){return $(e,t).map((function(e){var n=_(e.versionRegexes,t)
return{current:e.name,version:n}}))}(g,e).fold(G,J),y=function(e,t){return $(e,t).map((function(e){var n=_(e.versionRegexes,t)
...
return P(n)},st=function(e,t){var n=T(t,(function(t){return ut(e,t).getOr(t)}))
...
return P(r).each((function(t){var r,o,i,a,u,s,c,f
...
P(e).each((function(e){Ne(e.list,t.listAttributes),Ne(e.item,t.itemAttributes),Be(e.item,t.content)}))}(o,n),r=o,ct(P(t),I(r),lt),t.concat(o)},gt=function(e){return ge(e,"OL,UL")},vt=function(e){return Ae(e).map(gt).getOr(!1)},ht=function(e){return 0<e.depth},yt=function(e){return e.isSelected},St=function(e){var t=ke(e),n=De(e).map(gt).getOr(!1)?t.slice(0,-1):t
...
return n=t,i=a,r=function(e,t){i[t]=e},o=u,be(e,(function(e,t){(n(e,t)?r:o)(e,t)})),a}(e.listAttributes,(function(e,t){return"start"!==t})))}),(function(e){return r=e,(n=t).listType=r.listType,void(n.listAttributes=R({},r.listAttributes))
...
return n=e.contentDocument,r=A(o,(function(e,t){return(t.depth>e.length?pt:mt)(n,e,t)}),[]),I(r).map((function(e){return e.list})).toArray()},Tt=function(e,t,n){var r,o=function(e,t){var n,r=(n=!1,{get:function(){return n},set:function(e){n=e}})
...
s!==n&&(r.push(o),o=[]),n=s,o.push(u)}return 0!==o.length&&r.push(o),r}(a,ht),(function(e){return(I(e).map(ht).getOr(!1)?Lt:Nt)(i,e)})))
