...
D(n,o),_(n,o),n.selection.moveToBookmark(e)},I=function(n,t){var e,o,r=n.getBody(),i=n.selection
t.set(!t.get()),e=n,o=t.get(),e.fire("VisualChars",{state:o})
var u=i.getBookmark();(!0===t.get()?_:D)(n,r),i.moveToBookmark(u)},M=tinymce.util.Tools.resolve("tinymce.util.Delay"),F=function(n,t){return function(e){e.setActive(t.get())
var o=function(n){return e.setActive(n.state)}
return n.on("VisualChars",o),function(){return n.off("VisualChars",o)}}}
r.add("visualchars",(function(n){var t,e,o,r,i,u,c,a,s,l,f,d=(t=!1,{get:function(){return t},set:function(n){t=n}})
return o=d,(e=n).addCommand("mceVisualChars",(function(){I(e,o)})),i=d,(r=n).ui.registry.addToggleButton("visualchars",{tooltip:"Show invisible characters",icon:"visualchars",onAction:function(){return r.execCommand("mceVisualChars")},onSetup:F(r,i)}),r.ui.registry.addToggleMenuItem("visualchars",{text:"Show invisible characters",icon:"visualchars",onAction:function(){return r.execCommand("mceVisualChars")},onSetup:F(r,i)}),u=n,c=d,a=M.debounce((function(){q(u)}),300),!1!==u.getParam("forced_root_block")&&u.on("keydown",(function(n){!0===c.get()&&(13===n.keyCode?q(u):a())})),l=d,(s=n).on("init",(function(){var n=!s.getParam("visualchars_default_state",!1)
l.set(n),I(s,l)})),f=d,{isEnabled:function(){return f.get()}}}))}()
